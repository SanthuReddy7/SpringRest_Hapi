...
/**
 * <p>
 * Represents an HL7 PID message segment (Patient Identification). This segment
...
public class PID extends AbstractSegment {
	...
	private void init(ModelClassFactory factory) {
		try {
			...
			this.add(ID.class, false, 1, 1, new Object[] { getMessage(), new Integer(136) },
			...
			this.add(IS.class, false, 0, 20, new Object[] { getMessage(), new Integer(445) },
	...
	/**
	 * Returns a count of the current number of repetitions of Patient
	 * Identifier List (PID-3). This method does not create a repetition, so if
	 * no repetitions have currently been defined or accessed, it will return
	 * zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-3: "Patient Identifier List" -
	 * creates it if necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	 */
	...
	/**
	 * Inserts a repetition of PID-3: "Patient Identifier List" at a specific
	 * index
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	 * @throws HL7Exception
	 *             If the rep is invalid (below 0, or too high for the allowable
	 *             repetitions)
	 */
	...
	/**
	 * Removes a repetition of PID-3: "Patient Identifier List" at a specific
	 * index
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns a count of the current number of repetitions of Alternate Patient
	 * ID - PID (PID-4). This method does not create a repetition, so if no
	 * repetitions have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-4: "Alternate Patient ID - PID" -
	 * creates it if necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Inserts a repetition of PID-4: "Alternate Patient ID - PID" at a specific
	 * index
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Removes a repetition of PID-4: "Alternate Patient ID - PID" at a specific
	 * index
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns a count of the current number of repetitions of Patient Name
	 * (PID-5). This method does not create a repetition, so if no repetitions
	 * have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-5: "Patient Name" - creates it if
	 * necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns a count of the current number of repetitions of Mother's Maiden
	 * Name (PID-6). This method does not create a repetition, so if no
	 * repetitions have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-6: "Mother's Maiden Name" - creates
	 * it if necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns a count of the current number of repetitions of Patient Alias
	 * (PID-9). This method does not create a repetition, so if no repetitions
	 * have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-9: "Patient Alias" - creates it if
	 * necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	 ...
	 * This method does not create a repetition, so if no repetitions have
	 * currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a count of the current number of repetitions of Patient Address
	 * (PID-11). This method does not create a repetition, so if no repetitions
	 * have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-11: "Patient Address" - creates it
	 * if necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns a count of the current number of repetitions of Phone Number -
	 * Home (PID-13). This method does not create a repetition, so if no
	 * repetitions have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-13: "Phone Number - Home" - creates
	 * it if necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns a count of the current number of repetitions of Phone Number -
	 * Business (PID-14). This method does not create a repetition, so if no
	 * repetitions have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-14: "Phone Number - Business" -
	 * creates it if necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Inserts a repetition of PID-14: "Phone Number - Business" at a specific
	 * index
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Removes a repetition of PID-14: "Phone Number - Business" at a specific
	 * index
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns PID-20: "Driver's License Number - Patient" - creates it if
	 * necessary
	 */
	...
	/**
	 * Returns a count of the current number of repetitions of Mother's
	 * Identifier (PID-21). This method does not create a repetition, so if no
	 * repetitions have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-21: "Mother's Identifier" - creates
	 * it if necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns a count of the current number of repetitions of Ethnic Group
	 * (PID-22). This method does not create a repetition, so if no repetitions
	 * have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-22: "Ethnic Group" - creates it if
	 * necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns a count of the current number of repetitions of Citizenship
	 * (PID-26). This method does not create a repetition, so if no repetitions
	 * have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-26: "Citizenship" - creates it if
	 * necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns a count of the current number of repetitions of Identity
	 * Reliability Code (PID-32). This method does not create a repetition, so
	 * if no repetitions have currently been defined or accessed, it will return
	 * zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-32: "Identity Reliability Code" -
	 * creates it if necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Inserts a repetition of PID-32: "Identity Reliability Code" at a specific
	 * index
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Removes a repetition of PID-32: "Identity Reliability Code" at a specific
	 * index
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
	...
	/**
	 * Returns a count of the current number of repetitions of Tribal
	 * Citizenship (PID-39). This method does not create a repetition, so if no
	 * repetitions have currently been defined or accessed, it will return zero.
	 */
	...
	/**
	 * Returns a specific repetition of PID-39: "Tribal Citizenship" - creates
	 * it if necessary
	 *
	 * @param rep
	 *            The repetition index (0-indexed)
